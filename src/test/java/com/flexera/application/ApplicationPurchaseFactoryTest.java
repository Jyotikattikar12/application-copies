...
public class ApplicationPurchaseFactoryTest {
	...
	public void testCheckNumPuchasesFromEmail() {
		...
		applicationPurchaseCount = applicationPurchase.checkNumPuchases(row, userCompApp, copiesNum);
		...
		copiesNum = 2;
		applicationPurchaseCount = applicationPurchase.checkNumPuchases(row1, userCompApp, copiesNum);
		...
		copiesNum = 2;
		applicationPurchaseCount = applicationPurchase.checkNumPuchases(row3, userCompApp, copiesNum);
